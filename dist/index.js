...
const server = new McpServer({ name: "chinese-almanac-mcp", version: "1.0.0" }, {
...
server.tool("list_activities", "List the 8 supported event types with all accepted synonyms (EN/CN) 列出支持的择日活动与全部中英同义词 — use this to validate the activity argument before calling pick_auspicious_dates.", {}, async () => fmt({
    activities: [
